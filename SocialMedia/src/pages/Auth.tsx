...
const Auth: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen flex justify-center items-center ${isDarkMode ? 'bg-black' : 'bg-white'}`}>
      <div className="container max-w-2xl flex h-full flex-row">
        ...
        <div className="w-1/2 flex flex-col justify-between h-full p-4">
          <div className="border-2 border-gray-500 p-4 rounded-lg flex flex-col justify-between h-full">
            <img src="/logo.png" alt="Logo" className="self-center" />
            <AuthForm isLogin={isLogin} />
            <div className={`text-center ${isDarkMode ? "text-white" : "text-black"} p-4`}>
              ---------- OR ----------
            </div>
          ...
          <div className="flex justify-center mt-2 mb-2 space-x-4 border-2 border-gray-500 p-4 rounded-lg">
              {isLogin ? (
